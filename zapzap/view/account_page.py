...
class Ui_Account(object):
    def setupUi(self, Account):
        ...
        self.pushButton = QtWidgets.QPushButton(parent=self.account_scrollArea)
        ...
        spacerItem = QtWidgets.QSpacerItem(20, 323, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
    ...
    def retranslateUi(self, Account):
        ...
        self.pushButton.setText(_("Nova conta"))
        self.label_2.setText(_("Cria uma novo painel para acesso ao Whatsapp"))
