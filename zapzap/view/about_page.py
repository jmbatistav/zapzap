...
class Ui_About(object):
    ...
    def retranslateUi(self, About):
        ...
        self.label_3.setText(_("Veja mais sobre o ZapZap no nosso site."))
        self.pushButton.setText(_("Lean more"))
        self.label_5.setText(_("Report issue"))
        self.label_6.setText(_("Reporte um problema ou faça sua sugestão."))
        self.pushButton_2.setText(_("Report issue"))
